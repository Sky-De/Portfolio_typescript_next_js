...
export const AboutItemsData: AboutProps[] = [
  ...
  },
  {
    title: "Online work",
    desc: [
      "In addition to my technical expertise, I bring forth valuable assets such as my substantial contributions to @open-source projects on @GitHub with @+60 @merged @PR.",
