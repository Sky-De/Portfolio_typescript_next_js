  ...
  return (
    <div className="steps stepper">
      <div className={`activeStep ${step > 1 ? "activeLine" : ""}`}>
        <p>{step > 1 ? <i className="bx bx-check text-red-50"></i> : 1}</p>
      ...
      >
        <p>{step > 2 ? <i className="bx bx-check text-red-50"></i> : 2}</p>
        <h4 className="hidden md:block">COMPANY</h4>
      </div>

      <div className={`${step > 2 ? "activeStep" : ""}`}>
        <p>{step > 3 ? <i className="bx bx-check text-red-50"></i> : 3}</p>
