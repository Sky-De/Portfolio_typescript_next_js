        ...
        <g id="skills" transform="translate(0 1)">
          ...
          <g id="React" transform="translate(345.054 210.523)">
            ...
            <g id="react-2" transform="translate(8.888 7.85)">
              ...
              <g id="_2" fill="none" data-name="2" transform="translate(2.744)">
                <ellipse
                  id="Ellipse_81"
                  cx="6.254"
                  cy="15.957"
          ...
          <g id="Sass" transform="translate(282.419 5.951)">
            ...
            <g id="sass-2" fill="#ca73ae" transform="translate(12.359 12.387)">
              <path
                id="Path_176"
          ...
          <g id="Xd" transform="translate(455.408 176.133)">
            <g id="con-10" fill="#fff">
              <circle id="back-10" cx="23.537" cy="23.537" r="23.537"></circle>
              <circle
                id="border-10"
                cx="22.179"
                cy="22.179"
